...
//LOBBY + PROFILE INFO ========================================================================================================================
const DEMO_PROFILES = {
  test: { userName: 'test', bio: 'Just here to test the vibes 🌄 and see how everything looks on the site.',
...
const LOBBY_MEMBERS_KEY = 'lobbyMembers'  
...
worker.use(
  http.get('/api/publicProfile/:userName', (req) => {
